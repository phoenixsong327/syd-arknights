...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(MainActivity.this,listEmpolyee.class);
    ...
    private void init(){
        ...
        Cursor c = db.query("Record",new String[]{"name","rarity"},
                null,null,null,null,null);
        c.moveToFirst();
        while(!c.isAfterLast()){
            employees.add(new employee(c.getString(c.getColumnIndex("name")),c.getInt(c.getColumnIndex("rarity"))));
            c.moveToNext();
        }
    }
